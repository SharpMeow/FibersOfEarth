...
Keep changes focused and describe the user-visible outcome. Update a regression test for a behavioral fix. Check desktop, tablet and phone layouts, keyboard focus, empty results, direct routes and offline operation. Rebuild the root index.html when source files change.
